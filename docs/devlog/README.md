...
| AI/LLM | 반소람·정환주 | 5/5 + 부가 모듈 완성 | 회복점수 4축 산식 확정·교체 완료 (PR #284·#286) |
...
| 김윤한 | — | [→](members/김윤한.md) |
| 반소람 | 회복점수 4축 일원화(recovery_score_from_axes)·감정추론·폰사용 분석·PII·삼성헬스 파서, 게이트 4축 교체 검증(14일 하드코딩·difficulty 미저장 발견) | [→](members/반소람.md) |
