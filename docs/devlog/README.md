...
| ④ TTS 엔진 (Qwen3) | 정환주 | ✅ |
| ⑧ 평가 지표/집계 | 정환주 | ✅ |
| 회복 지수 재설계 | 반소람 | 🟢 4축 산식 확정·게이트 교체 반영(리포트 일원화 남음) ([설계문서](RECOVERY_SCORE_DESIGN.md)) |
...
| 모세종 | — | [→](members/모세종.md) |
| 김윤한 | — | [→](members/김윤한.md) |
| 반소람 | 회복점수 4축 일원화 함수(`recovery_score_from_axes`)·생활패턴 무페널티 재정규화, 옛↔새 산식 비교 스크립트, 게이트 4축 교체 검증(14일 하드코딩·difficulty 미저장 발견) | [→](members/반소람.md#2026-06-15-day-13) |
| 정환주 | — | [→](members/정환주.md) |
| 민경이 | — | [→](members/민경이.md) |
| 장민수 | — | [→](members/장민수.md) |
