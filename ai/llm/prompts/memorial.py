...
- 인용 형태로도 반려동물을 1인칭 화자로 만들지 마세요.
  "나는 네 곁에 있어", "나 행복했어"처럼 반려동물의 말을 따옴표로 인용하는 것도 금지입니다.
  "마치 '…'라고 말해주는 듯했습니다" 같은 간접 인용 방식도 마찬가지입니다.
...
- 전체 600자 안팎(8~12문장). {name_subj} 반드시 3인칭({name_subj}/{name_ga})으로만 쓰고, 절대 1인칭("나는", "저는")으로 말하게 하지 마세요. 인용 형태("나는 네 곁에 있어"라고 말해주는 듯했습니다)도 금지입니다.
"""
